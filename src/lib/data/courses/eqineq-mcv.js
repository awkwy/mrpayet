export default {id:"eqineq-mcv",classe:"bac pro MCV",mat:"Maths",titre:"Résolution graphique d'équations et d'inéquations",
 ...
 {t:"Le seuil de rentabilité d'Aïcha",
  ...
  steps:[
   ...
   {t:"Sur la calculatrice — retrouver le seuil autrement",viz:"courbe",
    vd:{f:(v)=>3*v-15,xl:[0,10],yl:[-15,15],xlab:"maillots vendus (x)",ylab:"D(x) = R(x) − C(x), en €",x0:5},
    apport:"Résoudre C(x) = R(x) revient exactement à résoudre <b>D(x) = 0</b>, où D(x) = R(x) − C(x) = 3x − 15 (l'écart entre recette et coût). Passe la calculatrice en mode <b>Lire un antécédent</b> et cherche l'antécédent de 0 : c'est le seuil de rentabilité, retrouvé sans repasser par le tableau."},
